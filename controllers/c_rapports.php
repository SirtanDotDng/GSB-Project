...
switch ($a) {
    ...
    case 'updateRapport' :
        ...
        editRapport($_SESSION['matricule'],$_GET['rap'], $_POST['rapDate'], $_POST['rapBilan'],date("Y-m-d"), $rapEtat, $_POST['praNum'] ,$_POST['medDepotLeg'],$_POST['medDepotLeg2'],$_POST['idMotif'],$_POST['motifAutre'],$_POST['remplacant']);
        if(isset($_POST['echantillon1']) && isset($_POST['qte1'])){
            saisieEchantillon($_POST['echantillon1'],$_SESSION['matricule'],(getNumRapport()-1),$_POST['qte1']);
        }
        if(isset($_POST['echantillon2']) && isset($_POST['qte2'])){
